"""
Django settings for red_smoke_dev_107776 project.
...
ROOT_URLCONF = 'red_smoke_dev_107776.urls'
...
WSGI_APPLICATION = 'red_smoke_dev_107776.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_smoke_dev_107776 API",
    "DESCRIPTION": "API documentation for red_smoke_dev_107776 App",
    "VERSION": "v1",
}
